...
function showMsg() {
    const isEmpty = uname.value === '' || pass1.value === ''|| pass1.value != pass2.value || fname.value === '' || lname.value=== '';
    ...
    if (isEmpty) {
        ...
        msg.style.color = '#06410c';
        btn.disabled = false;
        btn.classList.add('no-shift')
    }
}
function changepg(){
    window.location.href = "file:///Applications/XAMPP/xamppfiles/htdocs/CIA_3_Project/Login_page/login_page.html";
}
